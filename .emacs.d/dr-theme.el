...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(flycheck-fringe-warning ((,class (:background nil :foreground "#dd1144"))))
   `(flycheck-fringe-error ((,class (:background nil :foreground "#dd1144"))))
   `(flycheck-info ((,class (:background nil))))
   `(flycheck-warning ((,class (:background nil))))
   `(flycheck-error ((,class (:background nil))))
   ...
   `(font-lock-comment-face ((,class (:foreground "#999988"))))
   `(font-lock-constant-face ((,class (:foreground "#999999"))))
   ...
   `(isearch ((,class (:background "gray"))))
   `(isearch-lazy-highlight-face ((,class (:background "#cccccc"))))
   `(lazy-highlight ((,class (:background "#eeeeee"))))
