...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; 
   `(font-lock-exception-face ((,class (:foreground ,white :weight bold))))
   ...
   `(font-lock-type-face ((,class (:foreground ,white :weight bold))))
   ...
   `(font-latex-math-face ((,class (:foreground ,armygreen))))
